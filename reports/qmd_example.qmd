...
![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-province-highest-sd width = 65%}

In @fig-province-highest-sd we zoom in and look at the province of `{python} largest_sd_prov`, which had the largest spread of values in terms of standard deviation.
