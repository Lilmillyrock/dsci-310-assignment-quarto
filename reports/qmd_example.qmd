...
![Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png){#fig-all-provinces width=75%} 
...
We present the standard deviations in @tbl-horse-data.

```{python}
#| label: tbl-horse-data
...
Additionally, note that in @tbl-horse-data we consider the sample standard deviation of the number of horses during the same time span as @fig-all-provinces.

![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-province-highest-sd width=60% options="!h"}

In @fig-province-highest-sd we zoom in and look at the province of `{python} largest_sd`, which had the largest spread of values in terms of standard deviation.
